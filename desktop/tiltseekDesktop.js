...
document.getElementById("submit-button").addEventListener("click", function(event) {
	if (document.getElementById("textfield").value != "") {
		window.location.href = "tiltseekDesktop.html?username=" + document.getElementById("textfield").value + "&region=" + getRegionID(region);
	} else {
...
function displayError(errorMsg) {
	...
	document.getElementById("backgroundPatternLoading").style.display = "none";
	document.getElementById("backgroundPatternError").style.display = "block";
...
function loadDisplay(runList, index) {
	...
	document.getElementById("backgroundPatternLoading").style.display = "none";
	document.getElementById("backgroundPatternTeams").style.display = "block";
